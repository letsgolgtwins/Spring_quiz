...
import com.quiz.retry.lesson05.domain.MemberRetry;
...
public class Lesson05QuizControllerRetry {
	...
	@GetMapping("/quiz01/01")
	public String quiz01() {
		return "lesson05/quiz01Retry";
	}

	// lesson05 quiz02
	// http://localhost:8080/retry/lesson05/quiz02
	@GetMapping("/quiz02")
	public String quiz02(Model model) {
		...
		// model에 담기
		model.addAttribute("musicInfo", musicRanking);
		...
		// model에 담기
		model.addAttribute("memberInfo", membership);
		
		return "lesson05/quiz02Retry";
	}

	// lesson05 quiz03
	// http://localhost:8080/retry/lesson05/quiz03
	@GetMapping("/quiz03")
	public String quiz03(Model model) {
		// quiz03
		List<MemberRetry> members = new ArrayList<>();

		MemberRetry member = new MemberRetry();
		member.setName("유비");
		...
		// model에 담기
		model.addAttribute("memberInfo", members);
		
		return "lesson05/quiz03Retry";
	}
}